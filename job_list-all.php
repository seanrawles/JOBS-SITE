  		...
  		<div class="row">
			...
			<div class="col-md-4">
             		<div style="padding: 15px 0; float: right">
              		<a href="http://jobs.canneryresorts.com">
		  		<button type="button" class="btn btn-primary">New Job Request</button>
		  		</a>
				</div>
			</div>
		</div>
  		...
  		<div class="row">
  			<div class="col-md-12">
  				<div class="row">
					...
					<div class="col-md-6">
						<form method="post" action="search_records.php?go" id="searchform">
							<div class="input-group stylish-input-group"  style="max-width: 300px; float: right" >
                    				<input type="text" class="form-control"  placeholder="Search Jobs - OFFLINE" name="job_number">
...
?>
                <tr>
				 <td align="center"><a href="printable.php?job_numb=<?=$job_numb;?>" target="_blank" style="color: #666 !important"><p style="font-size: 16px; font-weight: bold"><?php echo $job_numb;?></p></a></td>
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
				 		  ...
				 		  <td><button type="button" class="btn btn-info btn-sm" data-toggle="modal" data-target="#attachments-<?php echo $job_numb;?>">Attachment(s)</button>
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
				 ...
				 <td><a href="job_list_individual.php?assignee=<?=$assignee;?>" target="new" style="color: #666 !important"><p style="font-size: 14px; font-weight: bold"><?php echo $assignee;?></p></a><?php echo $assign_email;?></td>
				 		  <td><?php echo $AE;?></td>
