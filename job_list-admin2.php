...
$sql = "SELECT * FROM jobs_canjobs JOIN employees ON employees.userid = jobs_canjobs.userid";
...
$sql = "SELECT * FROM jobs_canjobs JOIN employees ON employees.userid = jobs_canjobs.userid ORDER BY $order";
        ...
        <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
				 		  ...
				 		  <td><b><?php echo $requestor;?></b><br>
							  ...
							  For Property: <b><?php echo $Property;?></b>
                                ...
                                <td><?php echo $emp_name;?><br><?php echo $emp_email;?></td>
				 		  <td><?php echo $AE;?></td>
                                <td>
...
<div id="edit-<?php echo $job_numb;?>" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
		 <form method="post" action="form_action2b.php?attachment1=<?=$attachment1;?>&job_numb=<?=$job_numb;?>" enctype="multipart/form-data">
	  		<div class="container-fluid">
					...
					<div class="form-group">
						...
						<select class="form-control" id="AE" name="AE" style="max-width: 300px;">
							...
							<option value="2">Michelle Narayan</option>
    							<option value="3">Janice Mathews</option>
						</select>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<select class="form-control" id="userid" name="userid" style="max-width: 300px;">
							<option value="<?php echo $emp_name;?>" selected><?php echo $emp_name;?></option>
							<option value="6">Mimi Waite</option>
    							<option value="9">Marcy Johnson</option>
    							<option value="8">Paul Nitch</option>
    							<option value="7">Norah Strebel</option>
    							<option value="4">Sean Rawles</option>
    							<option value="5">Kerry McCombe</option>
						</select>
					</div>
					<div class="form-group">
