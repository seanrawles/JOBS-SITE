...
echo '<form action="./changepassword.php" method="post"> 
  ...
  <input type="hidden" value="'.$_SESSION['myusername'].'" name="myusername"> 
  <dl> 
    <dt> 
  ...
  <dl> 
    ...
    <dd> 
      <input name="password1" type="password" id="password1" maxlength="15"> 
    </dd> 
  </dl> 
  <dl> 
    <dt> 
...
function show_loginform($disabled = false)
{
  ...
  <dl> 
    ...
    <dd><input tabindex="1" accesskey="u" name="myusername" type="text" maxlength="30" id="username" /></dd> 
  </dl> 
  <dl> 
    <dt><label title="Password">Password: </label></dt> 
    <dd><input tabindex="2" accesskey="p" name="password1" type="password" maxlength="15" id="password1" /></dd> 
  </dl> 
  <ul> 
...
function show_lostpassword_form(){
  ...
  <dl> 
    ...
    <dd><input name="myusername" type="text" id="myusername" maxlength="30">
    </dd> 
  </dl> 
   <dl> 
...
function show_registration_form(){
  ...
  <dl> 
    ...
    <dd><input name="password1" type="password" id="password1" maxlength="15">
    </dd> 
  </dl> 
  <dl> 
