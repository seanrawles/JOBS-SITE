  			...
  			<div class="col-md-12">
  				<div class="row">
					...
					<div class="col-md-6" style="float: right">
						<form method="post" action="job_list_admin.php?go" id="searchform">
					...
					<div class="form-group">
						...
						<select class="form-control" id="assign_email" name="assign_email" style="max-width: 300px;">
							...
							<option value="mwaite@canneryresorts.com">mwaite@canneryresorts.com</option>
    							...
    							<option value="mnarayan@canneryresorts.com">mnarayan@canneryresorts.com</option>
    							<option value="jmathews@caneryresorts.com">jmathews@caneryresorts.com</option>
						</select>
					</div>
					<div class="form-group">
