...
?>
                <tr>
				 <td><a href="printable.php?job_numb=<?=$job_numb;?>" target="new" style="color: #666 !important"><p style="font-size: 18px; font-weight: bold"><?php echo $job_numb;?></p></a></td>
		 ...
		 <form method="post" action="form_action2.php" enctype="multipart/form-data">
	  		<div class="container-fluid">
		  			...
		  			<div class="form-group">
						...
						<textarea class="form-control" rows="10" id="comments" name="comments" maxlength="5000"><?php echo "$comments";?></textarea>
					</div>
					<div class="form-group">
